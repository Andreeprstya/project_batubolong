...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Pesona Batu Bolong</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?= base_url('admin/c_admin/profile/'.$_SESSION['id'])?>">Profile</a></li>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url('admin/c_admin/topup')?>">Tunai</a>
                                    <a class="nav-link" href="<?= base_url('admin/c_admin/nontunai')?>">Non Tunai</a>
                                </nav>
                            </div>
                            ...
                            <a class="nav-link" href="<?= base_url('admin/c_admin/pengunjung')?>">
                                Pengunjung
                            </a>
                            <a class="nav-link" href="<?= base_url('admin/c_admin/tiket')?>">
                                Tiket
                            </a>
